...
if __name__ == '__main__':
    ...
    processor = processor = CLIPProcessor.from_pretrained("patrickjohncyh/fashion-clip")

    image_transform = lambda image=None: {
        "image": torch.tensor(processor.image_processor(image)['pixel_values'][0])
    } 
